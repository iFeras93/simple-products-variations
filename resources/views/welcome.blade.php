                ...
                @auth
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ url("/home") }}"
                                                                                 class="underline text-gray-900 dark:text-white">Home
                                    Page</a>
                            </div>
                        </div>
                    </div>
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ url('my-orders') }}"
                                                                                 class="underline text-gray-900 dark:text-white">My
                                    Orders</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
            <div class="text-center text-sm text-gray-500 sm:text-left">
                <div class="flex items-center">
                    ...
                    <a href="{{ route('products.list') }}" class="ml-1 underline">
                        Products
                    </a>
                    ...
                    <a href="https://iferas93.com" class="ml-1 underline">
                        My Website
                    </a>
                </div>
            </div>
